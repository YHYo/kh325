    ...
    <footer class="footer pt-lg-5 pt-4 bg-secondary">
            ...
            <div class="row gy-4 ">
                ...
                <div class="col-lg   text-dark ">
                    ...
                    <ul class="list-unstyled fs-sm">
                        ...
                        <li><a class="nav-link p-0 fw-normal" href="#">문화유산연구지식</a></li>
                        <li><a class="nav-link p-0 fw-normal" href="#">KH정보교육원</a></li>
                    </ul>
                </div>
                <!-- Subscription form-->
        ...
        <div class="py-4 border-top border-dark ">
            <div class="container d-flex flex-column flex-lg-row align-items-center justify-content-between py-2 ">
                <!-- Copyright-->
                <p class="order-lg-1 order-2 fs-sm mb-2 mb-lg-0 "><span class="text-dark opacity-60 ">&copy; All rights reserved. Made by </span><a class="nav-link-light text-dark  fw-bold " href="https://createx.studio/ " target="_blank " rel="noopener ">사뿐사뿐</a></p>
