            ...
            <div class="container ">
                ...
                <div class="collapse navbar-collapse order-lg-2" id="navbarNav">
                    <ul class="navbar-nav navbar-nav-scroll" style="max-height: 35rem;">
                        ...
                        <li class="nav-item dropdown me-lg-2 p05">
                            <a class="nav-link  align-items-center pe-sm-1" href="#" onclick="location.href='<%=path%>/course/main'" role="button" aria-expanded="false" style="font-size: 22px;">
                        ...
                        <li class="nav-item dropdown me-lg-2 p05">
                            <a class="nav-link dropdown-toggle align-items-center pe-sm-1" href="#" onclick="location.href='<%=path%>/community/main'" data-bs-toggle="dropdown" role="button" aria-expanded="false" style="font-size: 22px;">
