            ...
            <tbody>
            	...
            	<%} else {%>
            		...
            		<%for(CommunityBoard b1 : list1) {%>
            			<tr>
            				<td>
            					<div class="etc1"><a href="<%=path+"/community/view?type=T&boardNo="+b1.getNo()%>"><%=b1.getTitle() %></a></div>
            				</td>
            				<td><%=b1.getuName() %></td>
            ...
            <tbody>
            	...
            	<%} else {%>
            		...
            		<%for(CommunityBoard b2 : list2) {%>
            			<tr>
            				<td>
            					<div class="etc1"><a href="<%=path+"/community/view?type=H&boardNo="+b2.getNo()%>"><%=b2.getTitle() %></a></div>
            				</td>
            				<td><%=b2.getuName() %></td>
            				<%-- 게시판 추천은 없는 것이라서 임의로 작성일 넣음 --%>
            ...
            <tbody>
            	...
            	<%} else {%>
            		...
            		<%for(CommunityBoard b3 : list3) {%>
            			<tr>
            				<td>
            					<div class="etc1"><a href="<%=path+"/community/view?type=F&boardNo="+b3.getNo()%>"><%=b3.getTitle() %></a></div>
            				</td>
            				<td><%=b3.getuName() %></td>
            				<%-- 게시판 추천은 없는 것이라서 임의로 작성일 넣음 --%>
