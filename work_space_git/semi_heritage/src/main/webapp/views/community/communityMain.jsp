 ...
 <!-- Hero-->
    ...
    <section class="container pt-1 mt-1">
        ...
        <div class="d-sm-flex align-items-center justify-content-between ">
            <h1 class="h2 mb-2"> <i class="fi-friends"></i> 함께해요</h1><a class="btn btn-link fw-normal p-0" href="<%=path%>/board/list">더보기<i class="fi-arrow-long-right ms-2"></i></a>
        </div>
        </h1>
        <hr>
        <div class="table-responsive">
            <table class="table" id="free_board" cellspacing="0">
                <tbody>
        ...
        <div class="left table-responsive">
            <div class="d-sm-flex align-items-center justify-content-between ">
                <h1 class="h2 mb-2 "> <i class="fi-search"></i> 역사연구소</h1><a class="btn btn-link fw-normal p-0" href="1boardMainStudy.html">더보기<i class="fi-arrow-long-right ms-2"></i></a>
            </div>
            </h1>
            <table class="table">
