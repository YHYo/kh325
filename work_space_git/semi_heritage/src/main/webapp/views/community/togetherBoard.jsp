...
<section class="container pt-1 mt-1">
    ...
    <div class="d-sm-flex align-items-center justify-content-between ">
        <h1 class="h2 mb-2"> <i class="fi-friends"></i> 함께해요</h1>
    </div>
    </h1>
    <div class="table-responsive">
        <table class="table" cellspacing="0" style="text-align:center">
            ...
            <tbody>
                ...
                <!-- <tr>
                    <td>10</td>
                    <td style="text-align:left">안양->파주 / 1박 2일 함께 가실분?!</td>
                    <td>유나영</td>
                    <td>22/07/18</td>
                ...
                <tr>
                    <td>9</td>
                    <td style="text-align:left">[16th] 소피의 사뿐사뿐 투어 모집합니다.</td>
                    <td>전소피아</td>
                    <td>22/07/18</td>
                    <td><em class="fi-eye-on"></em>&nbsp;20</td>
                    <td><em class="fi-chat-right"></em>&nbsp;5</td>
                ...
                <tr>
                    <td>8</td>
                    <td style="text-align:left">(男마감)안동하회마을 게스트하우스 벙개(25세-37세) </td>
                    <td>안동주인장</td>
                    <td>22/07/18</td>
                    <td><em class="fi-eye-on"></em>&nbsp;20</td>
                    <td><em class="fi-chat-right"></em>&nbsp;5</td>
                ...
                <tr>
                    <td>7</td>
                    <td style="text-align:left">[5번째 독도투어] 함께해요!!</td>
                    <td>나임 킴</td>
                    <td>22/07/18</td>
                    <td><em class="fi-eye-on"></em>&nbsp;20</td>
                    <td><em class="fi-chat-right"></em>&nbsp;5</td>
                ...
                <tr>
                    <td>6</td>
                    <td style="text-align:left">8월 15일 청와대 함께하실분!!</td>
                    <td>정원일</td>
                    <td>22/07/18</td>
                    <td><em class="fi-eye-on"></em>&nbsp;20</td>
                    <td><em class="fi-chat-right"></em>&nbsp;5</td>
    ...
    <div>
        ...
        <nav class="mt-2 mb-4" aria-label="Reviews pagination">
            <ul class="pagination">
                ...
                <%-- 처음으로 가기 --%>
                <li class="page-item">
                	<a class="page-link" href="<%=path%>/community/list?type=T&page=<%=pageInfo.getStartPage()%>" aria-label="Next"><i
                            class="fi-chevrons-left"></i></a>
                </li>
                
                <%-- 이전으로 가기 --%>
                <li class="page-item">
                	<a class="page-link" href="<%=path%>/community/list?type=T&page=<%=pageInfo.getPrvePage()%>" aria-label="Next"><i
                ...
                <% for(int i = pageInfo.getStartPage(); i <= pageInfo.getEndPage(); i++) {%>
					...
					<%} else {%>		
						<li class="page-item d-none d-sm-block"><a class="page-link" href="<%=path%>/community/list?type=T&page=<%=i%>"><%=i %></a></li>
					<%} %>		
				<%} %>
				
				<%-- 다음으로 가기 --%>
				<li class="page-item">
					<a class="page-link" href="<%=path%>/community/list?type=T&page=<%=pageInfo.getNextPage()%>" aria-label="Next"><i
                            class="fi-chevron-right"></i></a>
                </li>
                
				<%-- 마지막으로 가기 --%>
				<li class="page-item">
					<a class="page-link" href="<%=path%>/community/list?type=T&page=<%=pageInfo.getEndPage()%>" aria-label="Next"><i
