...
<%--                         <div class="d-flex d-md-block d-lg-flex align-items-start pt-lg-2 mb-4"><img class="rounded-circle2" src="<%=path+"/resources/upload/photo/"+loginMember.getRenamedPhoto()%>" width="48" onerror="this.src='<%=path%>/resources/img/semi-img/01.info.default.photo.png'" alt=<%=loginMember.getUemail()%>> --%>
