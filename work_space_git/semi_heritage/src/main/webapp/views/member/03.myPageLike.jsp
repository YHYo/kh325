            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 mb-5">
                    ...
                    <div class="card card-hover card-horizontal border-0 shadow-sm mb-4 ">
                        <div class="card-img-top position-relative " style="background-image: url(img/naim/03.like.heritage1.png); ">
                    ...
                    <!-- Item-->
                    <div class="card card-hover card-horizontal border-0 shadow-sm mb-4 ">
                        <div class="card-img-top position-relative " style="background-image: url(img/naim/03.like.heritage2.png); ">
                            <a class="stretched-link " href="real-estate-single-v1.html "></a>
                    ...
                    <!-- Item-->
                    <div class="card card-hover card-horizontal border-0 shadow-sm mb-4 ">
                        <div class="card-img-top position-relative " style="background-image: url(img/naim/03.like.heritage3.png); ">
                            <a class="stretched-link " href="real-estate-single-v1.html "></a>
                            <div class="position-absolute end-0 top-0 pt-3 pe-3 zindex-5 ">
                                <button class="btn btn-icon btn-light btn-xs text-primary rounded-circle shadow-sm " type="button " data-bs-toggle="tooltip " data-bs-placement="left " title="Remove from Wishlist ">
                                  <i class="fi-heart-filled" style="color: #C389FF;"></i></button>
                    ...
                    <!-- <div class="card card-hover card-horizontal border-0 shadow-sm ">
                        <div class="card-img-top position-relative " style="background-image: url(img/real-estate/catalog/17.jpg); ">
                            <a class="stretched-link " href="real-estate-single-v1.html "></a>
                        ...
                        <div class="card-body position-relative pb-3 ">
                            ...
                            <div class="d-flex align-items-center justify-content-center justify-content-sm-start border-top pt-3 pb-2 mt-3 text-nowrap "><span class="d-inline-block me-4 fs-sm ">4<i class="fi-bed ms-1 mt-n1 fs-lg text-muted
                            "></i></span><span class="d-inline-block me-4 fs-sm ">1<i class="fi-bath ms-1 mt-n1 fs-lg text-muted "></i></span><span class="d-inline-block fs-sm ">2<i class="fi-car ms-1 mt-n1 fs-lg text-muted "></i></span></div>
                        </div>
                    </div> -->
                </div>
            </div>
