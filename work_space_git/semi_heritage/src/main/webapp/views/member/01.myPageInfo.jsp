    ...
    <main class="page-wrapper">
        ...
        <header class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-scroll-header>
            <div class="container">
                ...
                </div><a class="btn btn-sm ms-2 order-lg-3" href="00.signIn.html" style="background-color: #8957BD; color: #fff;">로그아웃</a>
        ...
        <div class="container pt-5 pb-lg-4 mt-5 mb-sm-2">
            ...
            <div class="row">
                ...
                <aside class="col-lg-4 col-md-5 pe-xl-4 mb-5">
                    ...
                    <div class="card card-body border-0 shadow-sm pb-1 me-lg-1">
                        <div class="d-flex d-md-block d-lg-flex align-items-start pt-lg-2 mb-4"><img class="rounded-circle" src="img/naim/01.info.default.photo.png" width="48" alt="Annette Black">
                            ...
                            <!-- 프로필 하단 카테고리 시작 -->
                            <!-- herf : 게시글 작성 링크 첨부필요 -->
                        </div><a class="btn btn-lg w-100 mb-3" href="01.myPageInfo.html" style="background-color: #8957BD; color: #fff;"><i class="fi-plus me-2"></i>게시글 작성하기</a>
                        ...
                        <div class="collapse d-md-block mt-3" id="account-nav">
                            <div class="card-nav"><a class="card-nav-link active" style="color: #8957BD;" href="01.myPageInfo.html"><i class="fi-user opacity-60 me-2" ></i>회원정보 수정</a>
                ...
                <div class="col-lg-8 col-md-7 mb-5">
                    ...
                    <label class="form-label pt-2" for="account-bio"><b>All About You</b></label>
                    <div class="row pb-2">
                        <div class="col-lg-9 col-sm-8 mb-4">
                            <textarea class="form-control" id="account-bio" name="introduce" rows="6" placeholder="사뿐사뿐에 멋진 소개를 남겨주세요"></textarea>
                        </div>
                    ...
                    </div><a class="collapse-label collapsed d-inline-block fs-sm fw-bold text-decoration-none pt-2 pb-3" href="#showMoreSocials" style="color: #8957BD;" data-bs-toggle="collapse" data-bs-label-collapsed="Show more" data-bs-label-expanded="Show less"
                        role="button" aria-expanded="false" aria-controls="showMoreSocials"><i class="fi-arrow-down me-2" style="color: #8957BD;"></i></a>
                    <div class="d-flex align-items-center justify-content-between border-top mt-4 pt-4 pb-1">
                        <button class="btn px-3 px-sm-4" type="button" style="background-color:#8957BD; color: #fff;">변경사항 저장하기</button>
                        <button class="btn btn-link btn-sm px-0" type="button"><i class="fi-trash me-2"></i>회원탈퇴</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="d-flex flex-sm-row flex-column justify-content-between mx-n2">
                        <div class="mb-sm-0 mb-4 px-2">
                            ...
                            <div class="pt-2"><a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="#"><i class="fi-facebook"></i></a><a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="#"><i class="fi-twitter"></i></a>
                                <a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="#"><i class="fi-viber"></i></a><a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="#"><i class="fi-telegram"></i></a></div>
                        </div>
                        <div class="mb-sm-0 mb-4 px-2">
