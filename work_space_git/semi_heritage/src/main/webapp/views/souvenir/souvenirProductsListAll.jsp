                ...
                <div class="col-lg-9" style="padding-left: 20%;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between pb-4 mb-2">
                        <div class="d-flex align-items-center me-sm-4">
                            ...
                            <select name="categories" name="selectbox" onchange="chageLangSelect()" class="form-select form-select-light form-select-sm me-sm-4">
                                <option id="all" value="all"> 전체</option>
                                <option value="deco">생활/데코</option>
                                <option value="fashion">패션/잡화</option>
                                <option value="samu">사무/문구</option>
                                <option value="">유아/DIY</option>
                            ...
                            <div class="card card-light card-hover h-100">
                                ...
                                <div class="tns-carousel-wrapper card-img-top card-img-hover">
                                    ...
                                    <div class="tns-carousel-inner">
                                        <img src="<%=productListAll.get(i).getSouv_pro_url() %>" alt="Image">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between pb-1">
                                        <span class="fs-sm text-light me-3"><%=productListAll.get(i).getSouv_pro_category() %></span>
                                        <div class="form-check form-check-light">
                                           
                                        </div>
                                    </div>
                                    <h3 class="h6 mb-1">
                                        <a class="nav-link-light" href="<%=path %>/souvenirProductsDetail.do" style="color: #A08DB4;"><%=productListAll.get(i).getSouv_pro_name() %></a>
                                    </h3>
                                    <div class="text-primary fw-bold mb-1 ms-1"><%=df.format(productListAll.get(i).getSouv_pro_price()) %>원</div>
