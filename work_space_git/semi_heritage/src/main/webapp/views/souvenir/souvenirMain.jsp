...
<!-- Body-->
    <!-- Page loading spinner-->
            ...
            <div class="container pt-5">
                <div class="row pt-lg-4 pt-xl-5">
                    <div class="col-lg-6 col-md-5 pt-3 pt-md-4 pt-lg-5">
                        <h1 class="display-3 pb-1 mb-4 me-md-n5" style="color: #C389FF;">WELCOME TO MALL</h1>
        ...
        <section class="container pb-5 mb-md-4">
            <div class="row mb-5">
                <div class="col-md-8">
                    <p class="subtitle" style="font-size: 30px; color: #C389FF; margin-bottom : 1%"><b>Categories</b></p>
        ...
        <section class="container pt-sm-1 pb-5 mb-md-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4 pb-sm-2">
                <div class="col-md-8">
                    <p class="subtitle" style="font-size: 30px; color: #C389FF; margin-bottom : 1%"><b>Best items</b></p>
                    <h2 class="h3 text-light mb-2 mb-sm-0">인기상품</h3>
                </div>
        ...
        <section class="container pt-4 pt-md-5">
            <div class="col-md-8">
                <p class="subtitle" style="font-size: 30px; color: #C389FF; margin-bottom : 1%"><b>About us</b></p>
            ...
            <div class="row" style="margin-bottom: 60px;">
                <div class="col-md-5 col-lg-4 offset-lg-1 pt-4 mt-2 pt-md-5 mt-md-3">
                    <div class="d-flex pb-4 pb-md-5 mb-2">
                        ...
                        <div class="text-md-end ps-3 ps-md-0 pe-md-3 order-md-1" style="position: relative;">
                            <h3 class="h6 text-light mb-1">Over 1 Million Users</h3>
                            <p class="fs-sm text-light opacity-70 mb-0">사뿐몰은 백만명 이상의 이용자 분들이 선택한 국내 최대 전통 기념품 샵입니다
                            </p>
                        </div>
                    </div>
                    <div class="d-flex pb-4 pb-md-5 mb-2">
                        ...
                        <div class="text-md-end ps-3 ps-md-0 pe-md-3 order-md-1">
                            ...
                            <p class="fs-sm text-light opacity-70 mb-0">사뿐몰은 이용자 분들께 가치가 있는 전통 문화 상품만을 소개 해드립니다</p>
                        </div>
                    </div>
                    <div class="d-flex pb-4 pb-md-5 mb-2">
                        ...
                        <div class="text-md-end ps-3 ps-md-0 pe-md-3 order-md-1">
                            ...
                            <p class="fs-sm text-light opacity-70 mb-0">사뿐몰의 지속적이고 빠른 업데이트를 통해 이용자 분들이 사용하기 편리한 사이트를 제공 해드립니다</p>
                        </div>
                    </div>
                </div>
                <!-- 특징 왼쪽 3개 끝-->
                ...
                <div class="col-md-5 col-lg-4 pt-4 mt-2 pt-md-5 mt-md-3">
                    <div class="d-flex pb-4 pb-md-5 mb-2">
                        ...
                        <div class="ps-3">
                            ...
                            <p class="fs-sm text-light opacity-70 mb-0">
                                사뿐몰은 이용자 분들께 보다 더 정확하고 명확한 판매 상품 정보를 제공하고 있습니다
                    ...
                    <div class="d-flex pb-4 pb-md-5 mb-2">
                        ...
                        <div class="ps-3">
                            ...
                            <p class="fs-sm text-light opacity-70 mb-0">
                                사뿐몰은 높은 퀄리티의 고객 응대 및 CS 서비스를 제공하여 이용자 분들과의 활발한 소통을 지향하고 있습니다
                            </p>
                        </div>
                    </div>
                    <div class="d-flex pb-4 pb-md-5 mb-2">
                        ...
                        <div class="ps-3">
                            ...
                            <p class="fs-sm text-light opacity-70 mb-0">
                                사뿐몰 가입 시, 회원 한정 특별한 할인 혜택과 다양한 이벤트 응모 기회를 제공하고 있습니다
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="container">
            <div class="row align-items-center ">
                <div class="col-md-7 col-lg-6 col-xl-5 offset-xl-1 text-center text-md-start mb-3 mb-md-0">
                    <h2 class="text-light mb-4">전통과 현대를 아우르는 사뿐사뿐</h2>
                    <p class="fs-lg text-light opacity-70 mb-md-5">이젠 PC에서만이 아닌 모바일로도 스탬프를 찍을 수 있어요! <br> 2022년 12월 1일부터 다운로드 가능</p>
