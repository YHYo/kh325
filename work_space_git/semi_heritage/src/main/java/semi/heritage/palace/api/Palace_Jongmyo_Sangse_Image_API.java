...
public class Palace_Jongmyo_Sangse_Image_API {
	public static String palace_Jongmyo_Sangse_Image_XML_URL = "";

	public static void main(String[] args) {
		Palace_Jongmyo_Sangse_Image_API.callPalaceJongmyoSangseListByXML();

	}

	public static List<Palace_Jongmyo_Sangse_image> callPalaceJongmyoSangseListByXML() {

		List<Palace_Jongmyo_Sangse_image> list = new ArrayList<>();
		for (int seq = 0; seq < 127; seq++) {
			palace_Jongmyo_Sangse_Image_XML_URL = Palace_Jongmyo_API.callPalaceJongmyoListByXML().get(seq)
					.getLink();
					...
					if (node.getNodeType() == Node.ELEMENT_NODE) {
						...
						for (int j = 0; j < nList2.getLength(); j++) {
							...
							if (node2.getNodeType() == Node.ELEMENT_NODE) {
								...
								Palace_Jongmyo_Sangse_image pjsi = new Palace_Jongmyo_Sangse_image(
