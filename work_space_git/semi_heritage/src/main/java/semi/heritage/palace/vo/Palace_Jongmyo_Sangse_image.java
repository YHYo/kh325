...
public class Palace_Jongmyo_Sangse_image {
	...
	public Palace_Jongmyo_Sangse_image() {
		super();
	}

	public Palace_Jongmyo_Sangse_image(int serial_number, int gung_number, int detail_code, String imageIndex,
