...
public class Palace_Jongmyo_Sangse_Movie_Dao {

	// result
	public List<Palace_Jongmyo_Sangse_movie> selectAll(Connection conn) {
		...
		try {
			...
			while (rs.next()) {
				...
				Palace_Jongmyo_Sangse_movie info = new Palace_Jongmyo_Sangse_movie(serial_number, gung_number,
	...
	public int insert(Connection conn, Palace_Jongmyo_Sangse_movie pjs) {
		try {
