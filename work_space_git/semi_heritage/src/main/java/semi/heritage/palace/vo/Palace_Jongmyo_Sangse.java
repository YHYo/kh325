...
public class Palace_Jongmyo_Sangse {
	...
	public Palace_Jongmyo_Sangse() {
		super();
	}

	public Palace_Jongmyo_Sangse(int seq_pj_ss, int serial_number, int gung_number, int detail_code,
