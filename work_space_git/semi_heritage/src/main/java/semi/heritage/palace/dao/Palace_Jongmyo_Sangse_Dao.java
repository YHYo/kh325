...
public class Palace_Jongmyo_Sangse_Dao {

	// result
	public List<Palace_Jongmyo_Sangse> selectAll(Connection conn) {
		...
		try {
			...
			while (rs.next()) {
				...
				Palace_Jongmyo_Sangse info = new Palace_Jongmyo_Sangse(seq_pj_ss, serial_number, gung_number,
	...
	public int insert(Connection conn, Palace_Jongmyo_Sangse pjs) {
		try {
