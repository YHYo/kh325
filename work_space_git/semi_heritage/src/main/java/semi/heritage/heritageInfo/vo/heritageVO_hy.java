...
public class heritageVO_hy {
	
//	private int sn;					// 순번
	private int no;   				// 고유 키값(나는 순번을 no에 넣음
	...
	public heritageVO_hy() {
		super();
	}
	
	public heritageVO_hy(String ccbaKdcd, String ccbaCtcd, String ccbaAsno) {
		super();
	...
	public heritageVO_hy(/*int sn,*/ int no, String ccmaName, int crltsnoNm, String ccbaMnm1, String ccbaMnm2,
...
//		this.sn = sn;
	...
	public heritageVO_hy(String gcodeName, String bcodeName, String mcodeName, String scodeName, String ccbaQuan,
...
//	}
	...
	public String toString() {
		return "heritageVO ["
//				+ "sn=" + sn + ", "
				+ "no=" + no + ", ccmaName=" + ccmaName + ", crltsnoNm=" + crltsnoNm
